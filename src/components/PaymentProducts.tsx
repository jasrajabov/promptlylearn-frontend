            ...
            <Stack direction={{ base: "column", md: "row" }} gap={4}>
                {PRODUCTS.map((product) => (
                    <Box
                        ...
                        borderRadius="xl"
                        borderWidth="2px"
                        borderColor={selectedProduct === product.id ? "teal.600" : "gray.200"}
                        // bg={selectedProduct === product.id ? "blue.50" : "white"}
                        _hover={{
                            borderColor: selectedProduct === product.id ? "teal.600" : "gray.300",
                            shadow: "sm"
                        }}
                        transition="all 0.2s"
                    >
                        ...
                        <VStack align="start" gap={4}>
                            <Box>
                                ...
                                <HStack gap={1}>
                                    ...
                                    <Text color="gray.600">/ {product.id.includes("monthly") ? "month" : "year"}</Text>
                                </HStack>
                            </Box>
