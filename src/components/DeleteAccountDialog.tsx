                        ...
                        <VStack gap={4} align="stretch">
                            ...
                            >
                                ...
                                <VStack align="start" mt={2} pl={4} gap={1}>
                                    ...
                                    <Text fontSize="xs">• Your personal information and profile</Text>
                                    <Text fontSize="xs">• Your premium membership and subscription (if active)</Text>
                                    <Text fontSize="xs">• All learning progress and data</Text>
                                </VStack>
                                <Box mt={3} p={2} bg="orange.50" _dark={{ bg: "orange.900/20" }} borderRadius="md" borderWidth="1px" borderColor="orange.200">
                                    <Text fontSize="xs" fontWeight="semibold">
                                        ⚠️ Active subscriptions will be cancelled immediately and you will not be charged again.
                                    </Text>
                                </Box>
                            </Box>
                            ...
                            <Text fontSize="xs">
                                This action cannot be undone. A confirmation email will be sent to your email address.
                            </Text>
                        </VStack>
                    </Dialog.Body>
