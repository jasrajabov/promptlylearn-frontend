...
import { Button, Box, VStack, Spinner, Text, Dialog, Checkbox, Textarea } from '@chakra-ui/react';
                ...
                <Dialog.Content>
                    {loading ? (
                        ...
                        <>
                            ...
                            <Dialog.Body>
                                <VStack align="stretch" gap={4}>
                                    <Text fontSize="sm" color="gray.600" _dark={{ color: 'gray.400' }}>
                                        We'd love to know why you're cancelling. Your feedback helps us improve PromptlyLearn for everyone.
                                    </Text>

                                    <Box>
                                        <Text fontSize="sm" fontWeight="semibold" mb={3}>
                                            What's your main reason for cancelling? (Select all that apply)
                                        </Text>
                            ...
                            <Dialog.Footer>
                                <Button onClick={handleBackToConfirm} variant="outline" colorScheme="gray">
                                    Back
                                </Button>
                                <Button
                                    colorScheme="red"
                        ...
                        <>
                            ...
                            <Dialog.Body>
                                <VStack align="stretch" gap={4}>
                                    ...
                                    >
                                        <Text fontSize="sm" fontWeight="semibold" mb={2} color="yellow.900" _dark={{ color: 'yellow.100' }}>
                                            You'll lose access to:
                                        </Text>
                                        <VStack align="stretch" fontSize="sm" color="yellow.800" _dark={{ color: 'yellow.200' }} gap={1}>
