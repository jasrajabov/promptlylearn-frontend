...
import { FaCheck, FaTimes, FaLightbulb, FaArrowLeft, FaArrowRight, FaTrophy } from "react-icons/fa";
...
const ModuleQuiz: React.FC<ModuleQuizProps> = ({ quiz, setShowQuiz }) => {
    ...
    const scorePercentage = score !== null ? (score / quiz.questions.length) * 100 : 0;
                ...
                {!submitted ? (
                    ...
                    >
                        ...
                        <MotionCard
                            ...
                            shadow="md"
                        >
                            <Card.Header p={4} borderBottomWidth="1px" borderColor={borderColor}>
                                    ...
                                    {currentQuestion.options.map((option, oIdx) => {
                                        ...
                                        return (
                                            <Box
                                                ...
                                                transition="all 0.2s"
                                                _hover={{
                                                    borderColor: isSelected ? selectedBorder : accentColor,
                    ...
                    >
                        ...
                        <Card.Root
                            bg={cardBg}
                            borderWidth="2px"
                            borderColor={useColorModeValue(`${getScoreColor()}.200`, `${getScoreColor()}.700`)}
                            shadow="lg"
                            mb={4}
                        >
                            <Card.Body p={5}>
                                <VStack gap={3}>
                                    <Box
                                        ...
                                        h="60px"
                                        borderRadius="full"
                                        bg={useColorModeValue(`${getScoreColor()}.100`, `${getScoreColor()}.900/30`)}
                                        display="flex"
                                        alignItems="center"
                                        justifyContent="center"
                                    >
                                        {scorePercentage >= 80 ? (
                                            <Award size={32} color={useColorModeValue(`${getScoreColor()}.600`, `${getScoreColor()}.400`)} />
                                        ) : (
                                            <FaTrophy size={32} color={useColorModeValue(`${getScoreColor()}.600`, `${getScoreColor()}.400`)} />
                                        )}
                                    </Box>
                                    ...
                                    <HStack gap={4}>
                                        ...
                                        <VStack gap={0}>
                                            <Text fontSize="3xl" fontWeight="bold" color={useColorModeValue(`${getScoreColor()}.600`, `${getScoreColor()}.400`)}>
                        ...
                        <VStack gap={3} align="stretch">
                            {quiz.questions.map((q, qIdx) => {
                                const isCorrect = selectedAnswers[qIdx] === q.correct_option_index;
                                return (
                                    <Card.Root
                                        key={qIdx}
                                        bg={cardBg}
                                    ...
                                    >
                                        <Card.Header p={3} borderBottomWidth="1px" borderColor={borderColor}>
                                            <HStack justify="space-between">
                                                <HStack gap={1.5}>
                                                    <Badge
                                                        colorPalette="blue"
                                            ...
                                            <VStack align="stretch" gap={2}>
                                                {q.options.map((option, oIdx) => {
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <Text fontSize="xs" fontWeight={isCorrectOption || isSelected ? "semibold" : "normal"}>
                                                                {option}
                                                            </Text>
                                                            {icon}
                                                        </HStack>
